...
public class WebInformation {
    ...
    private WebInformation(){
        ...
        //hookContext初始化为一个新的空CopyOnWriteArraySet 集合，用于存储 CommonHook 类型的对象。
        //这样的数据结构在多线程环境下具有线程安全性，适合用于存储hook对象或其他需要并发访问的数据集合。
...
//        ConfigScanner.scan();
    ...
    public static void saveAttackInfo(AttackInfo attackInfo){
        ...
        try {
            ...
            //System.out.println("attackInfo.getAttackType(): " + attackInfo.getAttackType());
